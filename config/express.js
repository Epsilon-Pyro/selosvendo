...
// Configurar el motor view de la aplicación y el directorio 'views'
  ...
  require('../app/routes/autos.server.routes.js')(app);
  require('../app/routes/motos.server.routes.js')(app);
  require('../app/routes/servs.server.routes.js')(app);
